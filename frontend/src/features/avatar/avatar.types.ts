...
export const ANIMS: Record<string, number> = {
  ...
  // jamal tem 16: é o único clipe decalcado de vídeo real. A frase do vídeo tem
  // 32 frames a 24fps; aqui ela vai reamostrada de 2 em 2 e tocada a 12fps, o
  // que preserva a duração (1,333s). Ver o comentário de JAMAL em chibi.ts.
  idle: 8, walk: 4, run: 6, push: 4, jump: 5, hurt: 3,
  wave: 5, dance: 8, jamal: 16, dab: 4, floss: 6,
  punch: 4, getHit: 4, block: 3, type: 4, sit: 4, present: 4, coffee: 4, sleep: 4, celebrate: 6, lean: 4,
}
...
export const ANIM_LABELS: Record<string, string> = {
  ...
  type: "Digitar", sit: "Sentado", present: "Apresentar", coffee: "Café", sleep: "Dormir", celebrate: "Comemorar", lean: "Apoiado",
}

// FPS sugerido por animação.
export const ANIM_FPS: Record<string, number> = {
  jamal: 12, dance: 8, floss: 9, dab: 6, celebrate: 10, run: 12, walk: 8,
  punch: 10, getHit: 9, wave: 7, sleep: 3, type: 7, sit: 5, coffee: 5, idle: 4, lean: 3,
}
