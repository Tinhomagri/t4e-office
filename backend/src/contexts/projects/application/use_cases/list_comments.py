"""Caso de uso: listar comentários de um card."""
...
class ListComments:
    """Lista comentários de um card validando acesso ao workspace."""
    ...
    def execute(self, *, card_id: str, actor_id: str) -> list[CardComment]:
        ...
        return self.comment_repository.list_by_card(card_id=card_id)
